...
namespace SteamKit2
{
    ...
    /// </summary>
    /// <typeparam name="HdrType">The header type for this client message.</typeparam>
    public abstract class ServiceMsgBase<HdrType> : MsgBase, IServiceMsg
        where HdrType : ISteamSerializableHeader, new()
    {
        /// <summary>
        /// Gets a value indicating whether this client message is protobuf backed.
        ...
        /// </summary>
        /// <value>
        /// The target job name for RPC.
        /// </value>
        public abstract string TargetJobName { get; set; }
        ...
        /// </summary>
        /// <param name="payloadReserve">The number of bytes to initialize the payload capacity to.</param>
        public ServiceMsgBase(int payloadReserve = 0)
            : base(payloadReserve)
        {
            Header = new HdrType();
        }
